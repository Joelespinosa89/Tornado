...
namespace Padron.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("", "Este usuario esta en proceso de aprobación.");
                return View(model);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var rol = context.Roles.FirstOrDefault(x => x.Id == model.RolId);

                    var result2 = UserManager.AddToRole(user.Id, rol.Name);
